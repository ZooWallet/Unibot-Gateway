...
export const invalidPairError: string = 'The pair param is not a string.';
...
export const validatePair: Validator = mkValidator(
  'pair',
  invalidPairError,
  (val) => typeof val === 'string'
);
...
export const validateEstimateBuyTradeRequestRequest: RequestValidator =
  mkRequestValidator([]);
